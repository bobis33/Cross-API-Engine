...
static cae::KeyCode translateKey(const int key)
{
    static const std::unordered_map <int, cae::KeyCode> keyMap = {
        {GLFW_KEY_A, cae::KeyCode::A}, {GLFW_KEY_B, cae::KeyCode::B}, {GLFW_KEY_C, cae::KeyCode::C},
        {GLFW_KEY_D, cae::KeyCode::D}, {GLFW_KEY_E, cae::KeyCode::E}, {GLFW_KEY_F, cae::KeyCode::F},
        {GLFW_KEY_G, cae::KeyCode::G}, {GLFW_KEY_H, cae::KeyCode::H}, {GLFW_KEY_I, cae::KeyCode::I},
        {GLFW_KEY_J, cae::KeyCode::J}, {GLFW_KEY_K, cae::KeyCode::K}, {GLFW_KEY_L, cae::KeyCode::L},
        {GLFW_KEY_M, cae::KeyCode::M}, {GLFW_KEY_N, cae::KeyCode::N}, {GLFW_KEY_O, cae::KeyCode::O},
        {GLFW_KEY_P, cae::KeyCode::P}, {GLFW_KEY_Q, cae::KeyCode::Q}, {GLFW_KEY_R, cae::KeyCode::R},
        {GLFW_KEY_S, cae::KeyCode::S}, {GLFW_KEY_T, cae::KeyCode::T}, {GLFW_KEY_U, cae::KeyCode::U},
        {GLFW_KEY_V, cae::KeyCode::V}, {GLFW_KEY_W, cae::KeyCode::W}, {GLFW_KEY_X, cae::KeyCode::X},
        {GLFW_KEY_Y, cae::KeyCode::Y}, {GLFW_KEY_Z, cae::KeyCode::Z},

        {GLFW_KEY_0, cae::KeyCode::Num0}, {GLFW_KEY_1, cae::KeyCode::Num1}, {GLFW_KEY_2, cae::KeyCode::Num2},
        {GLFW_KEY_3, cae::KeyCode::Num3}, {GLFW_KEY_4, cae::KeyCode::Num4}, {GLFW_KEY_5, cae::KeyCode::Num5},
        {GLFW_KEY_6, cae::KeyCode::Num6}, {GLFW_KEY_7, cae::KeyCode::Num7}, {GLFW_KEY_8, cae::KeyCode::Num8},
        {GLFW_KEY_9, cae::KeyCode::Num9},
        {GLFW_KEY_ESCAPE, cae::KeyCode::Escape},
        {GLFW_KEY_LEFT, cae::KeyCode::Left}, {GLFW_KEY_RIGHT, cae::KeyCode::Right},
        {GLFW_KEY_UP, cae::KeyCode::Up}, {GLFW_KEY_DOWN, cae::KeyCode::Down},
        {GLFW_KEY_SPACE, cae::KeyCode::Space}, {GLFW_KEY_ENTER, cae::KeyCode::Enter},
        {GLFW_KEY_BACKSPACE, cae::KeyCode::Backspace}, {GLFW_KEY_TAB, cae::KeyCode::Tab},
        {GLFW_KEY_LEFT_SHIFT, cae::KeyCode::LShift}, {GLFW_KEY_LEFT_CONTROL, cae::KeyCode::LCtrl},
